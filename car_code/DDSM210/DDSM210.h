...
public:
	...
	//sun add 控制4个210电机 加速时间改为1
	virtual void ddsm210_ctrl_4( int cmd1, int cmd2,int cmd3,int cmd4,uint8_t act=1);
	//sun add 控制3个210电机  加速时间改为1
	virtual void ddsm210_ctrl_3( int cmd1, int cmd2,int cmd3,uint8_t act=1);
	//sun add 控制2个210电机 加速时间改为1
