...
// 串口总线舵机配置参数
#define ARM_SERVO_ID 0 //机械臂基座舵机ID号
#define GRIPPER_SERVO_ID 4      //爪子对应的舵机ID号
#define RT_SERVO_ID 5 //储料机构基座舵机ID号
...
FSUS_Protocol protocol(SERVO_BAUDRATE); //协议
FSUS_Servo arm_servo(ARM_SERVO_ID, &protocol); // 创建手臂旋转基座舵机
FSUS_Servo rt_servo(RT_SERVO_ID, &protocol);// 创建智能机械爪实例
FSUS_Servo gripper_servo(GRIPPER_SERVO_ID, &protocol);// 创建智能机械爪实例
