...
enum RunState
{
  self_check,//一键启动检测
  arm_go_home,//机械臂回参考点
  tell_car_to_go_to_QRCode_P1,
  tell_CAM_to_scan_display_QRCode,
  tell_car_to_go_to_storage_area_P2,
  ...
  tell_car_to_go_to_roughing_area,
  // tell_CAM_to_scan_position_deviation,
  // send_deviatione_to_car,
  pick_place_Object_to_roughing_area,
  tell_car_to_go_to_semifinished_area,
  // tell_CAM_to_scan_position_deviation,
  // send_deviatione_to_car,
  pick_place_Object_to_semifinished_area_down,
  tell_car_to_go_to_storage_area_again,
  pick_place_Object_to_semifinished_area_up,
  send_done_to_car
};
enum RunState run_state = self_check;
int speed = 260;
int dwellTime = 4;
