...
#define PINS_REVERSE  //根据电机测试结果注释或取消注释
#endif
#ifdef USE_A4950_DRIVER
#ifdef PINS_REVERSE
#define AIN1 6  // A电机控制PWM波
#define AIN2 5  // A电机控制PWM波

#define BIN1 8  // 9  qiiyiv1 // B电机控制PWM波
#define BIN2 7  // 12  qiiyiv1 // B电机控制PWM波

#define CIN1 12  // 7 9 qiiyiv1// C电机控制PWM波
#define CIN2 11  // 8 qiiyiv1  // C电机控制PWM波

#define DIN1 46  // D电机控制PWM波
#define DIN2 44  // D电机控制PWM波

#else
#define AIN1 5  // A电机控制PWM波
#define AIN2 6  // A电机控制PWM波

#define BIN1 7  // 9  qiiyiv1 // B电机控制PWM波
#define BIN2 8  // 12  qiiyiv1 // B电机控制PWM波

#define CIN1 11  // 7 9 qiiyiv1// C电机控制PWM波
#define CIN2 12  // 8 qiiyiv1  // C电机控制PWM波
...
#define ENCODER_A 51 // A路电机编码器引脚AA，外部中断，中断号0
#define DIRECTION_A 2  // A路电机编码器引脚AB

#define ENCODER_B 53  // B路电机编码器引脚BA，外部中断，中断号1
#define DIRECTION_B 3  // B路电机编码器引脚BB

#define ENCODER_C 52  // C路电机编码器引脚CA，外部中断，中断号5
#define DIRECTION_C 18  // C路电机编码器引脚CB

#define ENCODER_D 50  // D路电机编码器引脚DA，外部中断，中断号4
#define DIRECTION_D 19  // D路电机编码器引脚DB
...
#ifdef JMD18TFT  //晶美达1.8 TFT 7针 3.3V GM77-02
#define TFT_Modle ST7735
#define TFT_SCL 27
#define TFT_SDA 26
#define TFT_RST 25
