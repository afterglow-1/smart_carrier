...
#include <Arduino.h>
#include "OOPConfig.h"
#define ECATS_MPU6050
//#define JROWBERGB_MPU6050

//使用带DMP的支持ESP32的MPU6050库
#include "I2Cdev.h"
#ifdef  ECATS_MPU6050
#include "MPU6050_6Axis_MotionApps_V6_12.h"//https://github.com/electroniccats/mpu6050电子猫版和I2Cdev.h同时安装
 //点击自动打开管理库页面并安装: http://librarymanager/All#MPU6050
#endif
#ifdef  JROWBERGB_MPU6050
//#include "MPU6050_6Axis_MotionApps612.h"   // 如果安装是https://github.com/jrowberg/i2cdevlib版 请使用这个文件名
#endif
MPU6050 mpu;
