...
void updateTargetVelocity(int8_t ponit_n)
{
  ...
  if (max_time_flag)
  {
    ...
    x_max_time = int(abs(cpx - point[ponit_n].world_x) / botKps.MAX_x + 2);
    y_max_time = int(abs(cpy - point[ponit_n].world_y) / botKps.MAX_y + 2);
    z_max_time = int(abs(botOdometry.botPosition.heading_theta - point[ponit_n].world_angular_z) / botKps.MAX_z + 2);
  }
