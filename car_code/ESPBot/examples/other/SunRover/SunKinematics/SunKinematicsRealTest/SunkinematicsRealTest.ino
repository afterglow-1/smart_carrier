...
void setup() {
  ...
  Serial.println("Sunnybot Basic Encoder Real Test:");
}
void loop() {
  ...
  // Assuming you have an encoder for each wheel, you can pass this RPM value
  // to a PID controller as a setpoint and your encoder data as a feedback.
  ...
  // Now given the RPM from each wheel, you can calculate the linear and
  // angular velocity of the robot. This is useful if you want to create an
  // odometry data (dead reckoning)
#ifndef DEBUG
