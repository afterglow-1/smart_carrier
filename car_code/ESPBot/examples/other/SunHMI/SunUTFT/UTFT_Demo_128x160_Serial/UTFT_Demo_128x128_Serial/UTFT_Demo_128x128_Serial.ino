...
//#define JMD18TFT       //晶美达1.8 TFT 7针 3.3V
...
//UTFT myGLCD(Modle,SDA,SCL,CS,RST,RS);   // Remember to change the model parameter to suit your display module!
//UTFT myGLCD(ST7735,24,28,22,26,25);   // Remember to change the model parameter to suit your display module!
//UTFT myGLCD(ST7735,24,28,22,26,25);   // 绿深1.8 TFT
//UTFT myGLCD(ST7735,26,28,25,24,22);   // 晶美达1.8 TFT 7针
//UTFT myGLCD(ST7735, 26, 28, 24, 25, 22); // yUROBOT ARDUINO 屏幕
