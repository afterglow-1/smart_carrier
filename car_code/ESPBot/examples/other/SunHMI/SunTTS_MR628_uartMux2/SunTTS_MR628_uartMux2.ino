...
void loop() {
  ...
  //<I>18  提示音 1
  //<I>19  提示音 2
Serial3.print("<I>18");//播放提示音1
  delay(2000);
  //<M>1  背景音乐 1
  //<M>2  背景音乐 2
  //<M>0  关闭音乐
Serial3.print("<M>0");//背景音乐 1
  delay(50);
Serial3.print(sound0);//发送语音合成指令
  delay(6000);
Serial3.print(sound1);//发送语音合成指令  
  delay(6000);
Serial3.print(sound2);//发送语音合成指令  
  delay(6000);
  //   Serial3.print("<C>");//取消合成
  //    delay(50);
  Serial3.flush(); 
  uartMux.enableUART(1);
    //<I>18  提示音 1
  //<I>19  提示音 2
Serial3.print("<I>18");//播放提示音1
  delay(2000);
