...
#define GRIPPER_SERVO_ANGLE_OPEN 45   // 15.0   // 爪子张开时的角度
#define GRIPPER_SERVO_ANGLE_CLOSE -43 //-45.0 // 爪子闭合时的角度
...
#define FSARM_JOINT2_MAX 90.0
#define FSARM_JOINT3_MIN -135.0
